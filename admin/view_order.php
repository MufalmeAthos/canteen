                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form action="" method="post">
                        <button type="submit" disabled class="btn btn-sm btn-info" name="approve">Approve</button>
                      </form>
                        <?php
                      }
                      else {?>
...
<?php
if (isset($_POST['approve'])) {
  $sql = mysqli_query($conn,"UPDATE `user_order` SET `status`='Approved' WHERE `orderid`='$_POST[id]'");
  echo"<script>
    alert('Approved');
