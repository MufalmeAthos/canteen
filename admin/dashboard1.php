    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <li class="list-group-item active"><a href="#" style="color:white; text-decoration: none;">Dashboard</a></li>
                <li class="list-group-item"><a href="orders.php" style="color:black; text-decoration: none;">All Orders</a></li>
            ...
            <div class="col-sm-9  bg-light">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?= $row['email']; ?></td>
                        <td><?= $row['location']; ?></td>
                        <td><a href="view_order.php?id=<?= $row['orderid']; ?>" class=" btn btn-sm btn-outline-primary">view_orders</a></td>
                        <?php                         
                    }
                }
                else {
