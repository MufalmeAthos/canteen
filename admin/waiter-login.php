    ...
    <div class="modal-content">
      ...
      <?php
                if (isset($_POST['login1'])) {
                    ...
                    $sql = mysqli_query($conn,"SELECT * FROM `waiter` WHERE `email` ='$uname' AND `password` = '$pwd'");
                    ...
                    if (is_array($fetch) && !empty($fetch)) {
                        ...
                        echo '<div class="alert alert-success" style="width:80%; margin-left:10%; margin-right:10%;margin-top:2%;">
                            ...
                            header('location:waiter_home.php');
                        //echo'<META HTTP-EQUIV="Refresh" content="2; URL=waiter_home.php">';
                    }
                    else {
