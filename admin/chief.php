    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <li class="list-group-item "><a href="dashboard.php" style="color:black; text-decoration: none;">Dashboard</a></li>
                ...
                <li class="list-group-item active"><a href="chief.php" style="color:white; text-decoration: none;">Chief</a></li>
            ...
            <div class="col-sm-3 d-absolute">
                <div class="alert alert-info text-center"><strong>Add New Chef</strong></div>
        ...
        $em = $_POST['email'];
        $pass = $_POST['password'];
        $sql = "INSERT INTO `chef`( `names`, `email`, `phone`, `password`, `status`)
