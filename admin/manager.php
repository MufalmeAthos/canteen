    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <li class="list-group-item "><a href="dashboard.php" style="color:black; text-decoration: none;">Dashboard</a></li>
                <li class="list-group-item "><a href="clients.php" style="color:whiblackte; text-decoration: none;">Clients</a></li>
                <li class="list-group-item active" ><a href="manager.php" style="color:white; text-decoration: none;">Manager</a></li>
            ...
            <div class="col-sm-7  bg-light">
                ...
                <tbody>
                    <tr>
                        ...
                        <td><?= $row['email']; ?></td>
                        <td><?= $row['status']; ?></td>
                        <td><a href="editm.php?edit=<?= $row['mid']; ?>" class="btn btn-sm btn-info ">Edit</a>
            ...
            <div class="col-sm-3 d-absolute">
                <div class="alert alert-info text-center"><strong>Add New Manager</strong></div>
        ...
        $em = $_POST['email'];
        $pass = $_POST['password'];
        $sql = "INSERT INTO `manager`( `names`, `email`, `phone`, `password`, `status`)
