    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link " href="my_cart.php"><img src="crt.png" height="20" width="20"><span style="color:rgb(226, 171, 0); margin-top: -15px;">
            <?php
            $count = 0;
      ...
      <a href="#book-a-table" class="  d-none d-lg-flex"></a>
